...
//        updateDisplayImage(entity: getDataEntity())
    ...
    func getDataEntity() -> NSManagedObject {
        ...
        print("creating a new entity instance")
        
        // create entity description
        // this returns optional since entity name can be invalid
        let entityDescription = NSEntityDescription.entity(forEntityName: "DataEntity", in: context)!
